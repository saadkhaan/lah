      ...
      <div className="grid md:grid-cols-2 items-center gap-8 px-4 sm:px-0 sm:py-0">
        ...
        <div className="mb-20 md:mb-0 md:mr-40">
          ...
          <p className="text-gray-900 text-lg">
            ...
            sense of narrative. Today, Laith approaches each project as a
            personal story, working closely with clients to create interiors
            that reflect their lifestyle and identity. His designs balance
            structure and spontaneity, blending classic influences with
            contemporary living to achieve spaces that are warm, elegant, and
            enduring.
          </p>
        </div>
      </div>
